...
dict_configs = {
    ...
    # -------------------------
    # KV hybrids (usually "free" because you already support KV_bit)
    # -------------------------
    ...
    # Optional: if you want symmetry with your uniform KV=4 baseline
...
# Quick inference test (only on rank 0 to avoid duplicate output)
if is_main_process(rank):
...
for epoch in range(num_epochs):
    ...
    # Epoch summary - average training loss (reduce across processes)
    if is_distributed:
        for p in precisions:
